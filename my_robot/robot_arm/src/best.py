...
def run():
    ...
    data=ROOT / 'data/best.yaml'  # dataset.yaml path
    ...
    pub = rospy.Publisher('obj_pos_tp', Quaternion, queue_size=10)
    ...
    while not rospy.is_shutdown():
        ...
        #             cv2.putText(im0, text=coordinate_text, org=(int((xyxy[0] + xyxy[2])/2), int((xyxy[1] + xyxy[3])/2)), fontFace = cv_font,
